...
\usepackage{polyglossia} %cizi jazyky
\usepackage{csquotes} %uvozovky
\usepackage{xevlna} %tím pádem se nebudou trhat jednoslovné předložky
\usepackage{metalogo} %logo xelatexu
...
\begin{document}
	...
	\begin{table}[h!t] %here nebo top, výchozí je top
